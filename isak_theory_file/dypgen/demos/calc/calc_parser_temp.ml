...
(_:'dypgen__Obj_expr)
# 76                 "calc_parser_temp.ml"
 as _1)); `Lexeme_matched _2] -> `Obj_main 
# 6 "calc_parser.dyp"
(
                ( _1 ):'dypgen__Obj_main)
# 81                 "calc_parser_temp.ml"
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [ `Lexeme_matched _1;`Obj_expr ( (
(_:'dypgen__Obj_expr)
# 99                 "calc_parser_temp.ml"
 as _2))] -> `Obj_expr 
# 10 "calc_parser.dyp"
(
                             ( -_2 ):'dypgen__Obj_expr)
# 104                "calc_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [ `Lexeme_matched _1;`Obj_expr ( (
(_:'dypgen__Obj_expr)
# 112                "calc_parser_temp.ml"
 as _2)); `Lexeme_matched _3] -> `Obj_expr 
# 11 "calc_parser.dyp"
(
                             ( _2 ):'dypgen__Obj_expr)
# 117                "calc_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
...
(_:'dypgen__Obj_expr)
# 128                "calc_parser_temp.ml"
 as _3))] -> `Obj_expr 
# 12 "calc_parser.dyp"
(
                             ( _1 + _3 ):'dypgen__Obj_expr)
# 133                "calc_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
(("expr",[Dyp.Non_ter ("expr",Dyp.Lesseq_priority "pp");Dyp.Regexp (Dyp.RE_String "-");Dyp.Non_ter ("expr",Dyp.Less_priority "pp")],"pp",[]),
