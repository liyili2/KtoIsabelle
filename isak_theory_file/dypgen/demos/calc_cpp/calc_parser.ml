...
(_:'dypgen__Obj_expr)
# 83                 "calc_parser_temp.ml"
 as _1)); Lexeme_matched _2] -> Obj_main 
# 7 "calc_parser.dyp"
(
                ( _1 ):'dypgen__Obj_main)
# 88                 "calc_parser_temp.ml"
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [ Lexeme_matched _1;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 106                "calc_parser_temp.ml"
 as _2))] -> Obj_expr 
# 4 "expr.dyp"
(
                  ( -_2 ):'dypgen__Obj_expr)
# 111                "calc_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [ Lexeme_matched _1;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 119                "calc_parser_temp.ml"
 as _2)); Lexeme_matched _3] -> Obj_expr 
# 5 "expr.dyp"
(
                 ( _2 ):'dypgen__Obj_expr)
# 124                "calc_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [Obj_expr ( (
(_:'dypgen__Obj_expr)
# 180                "calc_parser_temp.ml"
 as _1)); Lexeme_matched _2;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 183                "calc_parser_temp.ml"
 as _3))] -> Obj_expr 
# 9 "expr.dyp"
(
                             ( _1 / _3 ):'dypgen__Obj_expr)
# 188                "calc_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])],
