...
type ('dypgen__Inh_dypgen__early_action_0, 'dypgen__Obj_dypgen__early_action_0, 'dypgen__Obj_dypgen__epsilon, 'dypgen__Obj_expr, 'dypgen__Obj_main) obj =
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [Obj_expr ( (
(_:'dypgen__Obj_expr)
# 143                "calc_parser_temp.ml"
 as _1)); Lexeme_matched _2;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 146                "calc_parser_temp.ml"
 as _3))] -> Obj_expr 
# 31 "calc_parser.dyp"
(
                                   ( _1 + _3 ):'dypgen__Obj_expr)
# 151                "calc_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
(("expr",[Dyp.Non_ter ("0_1",Dyp.No_priority );Dyp.Regexp (Dyp.RE_String "&");Dyp.Non_ter ("dypgen__early_action_0",Dyp.No_priority );Dyp.Non_ter ("expr",Dyp.No_priority )],"pi",[]),
Dyp.Dypgen_action (fun __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl ->
...
(_:string)
# 181                "calc_parser_temp.ml"
 as _1))] ->  let res = 
# 32 "calc_parser.dyp"
(
           ( (), add_times ):'dypgen__Obj_dypgen__early_action_0 * ('t,'obj,'gd,'ld,'l) Dyp.dyp_action list)
