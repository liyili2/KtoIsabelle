...
# 1 "global_data_parser.dyp"
 open Dyp
let global_data = 0
let global_data_equal = (=) 
let _ = () (* dummy line to improve OCaml error location *)
# 82                 "global_data_parser_temp.ml"
...
Dyp.Dypgen_action (fun __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl ->
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [ Lexeme_matched _1] ->  let res = 
# 17 "global_data_parser.dyp"
(
      ( int_of_string _1, [Global_data (dyp.global_data+1)] ):'dypgen__Obj_expr * ('t,'obj,'gd,'ld,'l) Dyp.dyp_action list)
# 106                "global_data_parser_temp.ml"
  in Obj_expr(fst res), snd res
 | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
(("expr",[Dyp.Non_ter ("expr",Dyp.Lesseq_priority "pp");Dyp.Regexp (Dyp.RE_String "+");Dyp.Non_ter ("expr",Dyp.Less_priority "pp")],"pp",[]),
Dyp.Dypgen_action (fun __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl ->
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [Obj_expr ( (
(_:'dypgen__Obj_expr)
# 115                "global_data_parser_temp.ml"
 as _1)); Lexeme_matched _2;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 118                "global_data_parser_temp.ml"
 as _3))] ->  let res = 
# 19 "global_data_parser.dyp"
(
      ( _1 + _3, [Global_data (dyp.global_data+1)] ):'dypgen__Obj_expr * ('t,'obj,'gd,'ld,'l) Dyp.dyp_action list)
# 123                "global_data_parser_temp.ml"
  in Obj_expr(fst res), snd res
 | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
(("expr",[Dyp.Non_ter ("expr",Dyp.Lesseq_priority "pt");Dyp.Regexp (Dyp.RE_String "*");Dyp.Non_ter ("expr",Dyp.Less_priority "pt")],"pt",[]),
Dyp.Dypgen_action (fun __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl ->
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [Obj_expr ( (
(_:'dypgen__Obj_expr)
# 132                "global_data_parser_temp.ml"
 as _1)); Lexeme_matched _2;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 135                "global_data_parser_temp.ml"
 as _3))] ->  let res = 
# 21 "global_data_parser.dyp"
(
      ( _1 * _3, [Global_data (dyp.global_data+1)] ):'dypgen__Obj_expr * ('t,'obj,'gd,'ld,'l) Dyp.dyp_action list)
# 140                "global_data_parser_temp.ml"
  in Obj_expr(fst res), snd res
 | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])],
