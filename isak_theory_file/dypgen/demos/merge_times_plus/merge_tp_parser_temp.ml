...
(_:'dypgen__Obj_expr)
# 116                "merge_tp_parser_temp.ml"
 as _1)); Lexeme_matched _2] -> Obj_main 
# 21 "merge_tp_parser.dyp"
(
                  ( _1 ):'dypgen__Obj_main)
# 121                "merge_tp_parser_temp.ml"
...
# 24 "merge_tp_parser.dyp"
(
                  ( Int (int_of_string _1) ):'dypgen__Obj_expr)
# 131                "merge_tp_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [Obj_expr ( (
(_:'dypgen__Obj_expr)
# 139                "merge_tp_parser_temp.ml"
 as _1)); Lexeme_matched _2;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 142                "merge_tp_parser_temp.ml"
 as _3))] -> Obj_expr 
# 25 "merge_tp_parser.dyp"
(
                  ( Plus (_1,_3) ):'dypgen__Obj_expr)
# 147                "merge_tp_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])
;
(("expr",[Dyp.Non_ter ("expr",Dyp.No_priority );Dyp.Regexp (Dyp.RE_String "*");Dyp.Non_ter ("expr",Dyp.No_priority )],"default_priority",[]),
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [Obj_expr ( (
(_:'dypgen__Obj_expr)
# 155                "merge_tp_parser_temp.ml"
 as _1)); Lexeme_matched _2;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 158                "merge_tp_parser_temp.ml"
 as _3))] -> Obj_expr 
# 26 "merge_tp_parser.dyp"
(
                  ( Times (_1,_3) ):'dypgen__Obj_expr)
# 163                "merge_tp_parser_temp.ml"
,[] | _ -> raise Dyp.Giveup))) __dypgen_ol __dypgen_pos __dypgen_posl __dypgen_gd __dypgen_ld __dypgen_lld __dypgen_di __dypgen_p __dypgen_nl),
[])],
...
[
  4,((fun lexbuf -> Obj___dypgen_layout))]),
