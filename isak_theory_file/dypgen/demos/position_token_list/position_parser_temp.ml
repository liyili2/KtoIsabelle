...
let dypgen_lexbuf_position lb = lb.token_position


let _ = () (* dummy line to improve OCaml error location *)
# 127                "position_parser_temp.ml"
...
(_:'dypgen__Obj_expr)
# 134                "position_parser_temp.ml"
 as _1)); _2] -> Obj_main 
# 23 "position_parser.dyp"
(
                ( _1 ):(Parse_tree.tree))
...
(_:(int))
# 147                "position_parser_temp.ml"
 as _1)] -> Obj_expr 
# 26 "position_parser.dyp"
(
                   (
      Printf.printf "int:%d\n" _1;
...
(Dyp.Tools.transform_action (fun dyp __dypgen_av_list -> (match (__dypgen_av_list) with [Obj_expr ( (
(_:'dypgen__Obj_expr)
# 165                "position_parser_temp.ml"
 as _1)); _2;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 168                "position_parser_temp.ml"
 as _3)); _4;Obj_expr ( (
(_:'dypgen__Obj_expr)
# 171                "position_parser_temp.ml"
 as _5))] -> Obj_expr 
# 32 "position_parser.dyp"
(
                              (
