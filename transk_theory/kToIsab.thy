theory kToIsab
imports Main k isabInIsab
begin

fun getAllCellNames :: "('upVar, 'var, 'metaVar) suB list
         \<Rightarrow> 'var var list"
  and  getAllCellNamesAux :: "('upVar, 'var, 'metaVar) suBigKWithBag
         \<Rightarrow> 'var var list" where
"getAllCellNames [] = []"
